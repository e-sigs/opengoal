...
```
~/.config/opencode/skills/goal-tracker/goals
```
...
# Add a main goal
/goals-main Implement new API endpoint
...
| Command | Description |
|---------|-------------|
| `/goals-main <title>` | Add new main goal |
| `/goals-sub <parent-id> <title>` | Add sub-goal |
...
| `/goals-list` | 152ms | 14ms | 10.8x |
| `/goals-summary` | 161ms | 16ms | 10x |
...
# Add task
~/.config/opencode/skills/goal-tracker/goals task-add "My task" high
...
### Permission denied
```bash
chmod +x ~/.config/opencode/skills/goal-tracker/goals
```
