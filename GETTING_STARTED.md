...
/goals-list              # Check goals
/task-done <id>          # Mark tasks complete
/goals-done <id>         # Mark goals complete
```

### Evening
```bash
/goals-summary           # Review the day
```
...
```bash
# Add a main goal
/goals-main Implement user authentication
...
# Add them
/goals-sub mg-xxx Research JWT implementation
/goals-sub mg-xxx Create auth middleware
...
2. Add your first goal with `/goals-main`
3. Add quick tasks with `/task-add`
4. Mark things complete as you go
5. Review progress with `/goals-summary`
